...
var _user$project$Main$txtColor = _rtfeldman$elm_css$Css$hex('60B5CC');
var _user$project$Main$codeBgColor = A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230);
var _user$project$Main$bgColor = A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255);
var _user$project$Main$font = _rtfeldman$elm_css$Css$px(20);
var _user$project$Main$elmBlueOnWhite = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css_Elements$body(
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Main$bgColor),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$color(_user$project$Main$txtColor),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$fontFamilies(
									{
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$fontSize(_user$project$Main$font),
									_1: {
										ctor: '::',
			...
			_0: _rtfeldman$elm_css$Css_Elements$section(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'background-position', 'center'),
								_1: {
									ctor: '::',
									_0: A2(_rtfeldman$elm_css$Css$property, 'background-size', 'cover'),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$displayFlex,
										_1: {
					...
					_0: _rtfeldman$elm_css$Css_Elements$code(
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Main$codeBgColor),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Main$blur = function (completion) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'blur(',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Basics$round((1 - completion) * 10)),
			'px)'));
};
var _user$project$Main$verticalDeck = function (status) {
	return _rtfeldman$elm_css$Css$asPairs(
		function () {
			var _p0 = status;
			if (_p0.ctor === 'Still') {
...
var _user$project$Main$betterFade = function (completion) {
	return _rtfeldman$elm_css$Css$asPairs(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$opacity(
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$property,
					'filter',
					_user$project$Main$blur(completion)),
				_1: {
					ctor: '::',
					_0: A2(
						_rtfeldman$elm_css$Css$property,
...
var _user$project$Main$main = A2(
	...
	_elm_lang$core$Native_Utils.update(
		...
		{style: _user$project$Main$elmBlueOnWhite, slideAnimator: _user$project$Main$verticalDeck, fragmentAnimator: _user$project$Main$betterFade}),
	{
		ctor: '::',
